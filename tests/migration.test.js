/**
 * Comprehensive tests for the legacy CATTLE ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ PostgreSQL migration system.
 *
 * Test suites:
 *   1. Transform helpers (unit tests ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no DB required)
...
// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Test DB setup ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
...
describe('Transform helpers', () => {
  ...
  describe('mapSex', () => {
    it('maps specific male codes', () => {
      expect(mapSex('S')).toBe('steer');
      expect(mapSex('B')).toBe('bull');
      expect(mapSex('M')).toBe('steer');
      expect(mapSex('s')).toBe('steer');
    });

    it('maps specific female codes', () => {
      expect(mapSex('H')).toBe('heifer');
      expect(mapSex('C')).toBe('cow');
      expect(mapSex('F')).toBe('heifer');
      expect(mapSex(null)).toBe('heifer');
      expect(mapSex('')).toBe('heifer');
    });
  });
...
describe('Migration runner ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â integration', () => {
  beforeEach(async () => {
  ...
  describe('Breeds migration', () => {
    it('migrates breeds correctly', async () => {
      ...
      expect(res.rows[0].label).toBe('Angus');
      expect(res.rows[2].label).toBe('Brahman'); // trimmed
    });
  ...
  describe('Full migration flow', () => {
    it('migrates lookup ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ cattle ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ events in correct order', async () => {
      const mock = createMockMssql({
        'Breeds': [
          { Breed_Code: 1, Breed_Name: 'Angus' },
        ],
      ...
      expect(cows.rows[0].sex).toBe('steer');  // 'S'
    ...
    it('handles dead cattle status correctly', async () => {
      ...
      expect(res.rows[0].sex).toBe('heifer');  // 'H'
    });
  ...
  describe('Costs migration', () => {
    ...
    it('skips costs rows with null amount', async () => {
      ...
      if (cowRes.rows.length === 0) {
        ...
        await pgPool.query(`
          INSERT INTO cattle.cows (ear_tag, legacy_beast_id, died, sex) VALUES ('NULL_AMT', 88001, false, 'heifer')
        `);
      }
...
describe('Post-migration validation', () => {
  it('passes all checks on clean migrated data', async () => {
    ...
    await pgPool.query("INSERT INTO system.lookups (category, code, label) VALUES ('breed', 1, 'Angus')");
    await pgPool.query(`
      INSERT INTO cattle.cows (ear_tag, legacy_beast_id, died, sex) VALUES ('T001', 500, false, 'heifer')
    `);
    const cowRes = await pgPool.query("SELECT id FROM cattle.cows WHERE ear_tag = 'T001'");
    const cowId = cowRes.rows[0].id;

    await pgPool.query(`
      INSERT INTO weighing.weighing_events (beastid, cow_id, weighing_type, weight, weigh_date)
      VALUES ($1, $1, 1, 300, NOW())
    `, [cowId]);
    ...
    // cow_id populated checks should pass
    const cowIdChecks = checks.filter(c => c.check.includes('cow_id populated'));
    for (const c of cowIdChecks) {
      expect(c.passed).toBe(true);
    }
  });

  it('detects negative weights', async () => {
    await pgPool.query("INSERT INTO system.lookups (category, code, label) VALUES ('breed', 99, 'Test') ON CONFLICT DO NOTHING");
    await pgPool.query(`
      INSERT INTO cattle.cows (ear_tag, legacy_beast_id, died, sex) VALUES ('NEG001', 999, false, 'heifer')
    `);
...
describe('Edge cases', () => {
  ...
  it('handles special characters in data', async () => {
    ...
    const res = await pgPool.query("SELECT label FROM system.lookups WHERE category = 'breed' AND code = '52'");
    expect(res.rows[0].label).toBe('Breed; DROP TABLE breeds;--');
  ...
  it('handles unicode data correctly', async () => {
    const mock = createMockMssql({
      'Contacts': [
        {
          Contact_ID: 100, Company: 'ÃƒÂ¦Ã¢â‚¬â€Ã‚Â¥ÃƒÂ¦Ã…â€œÃ‚Â¬ÃƒÂ§Ã¢â‚¬Â°Ã‚Â§ÃƒÂ¥Ã‚Â Ã‚Â´', Last_Name: 'MÃƒÆ’Ã‚Â¼ller',
          First_Name: 'JosÃƒÆ’Ã‚Â©', Tel_No: null, Email: 'josÃƒÆ’Ã‚Â©@example.com',
          Address_1: 'StraÃƒÆ’Ã…Â¸e 42', ABN: null, Notes: null,
        },
      ],
    });
    ...
    expect(res.rows[0].company).toBe('ÃƒÂ¦Ã¢â‚¬â€Ã‚Â¥ÃƒÂ¦Ã…â€œÃ‚Â¬ÃƒÂ§Ã¢â‚¬Â°Ã‚Â§ÃƒÂ¥Ã‚Â Ã‚Â´');
    expect(res.rows[0].last_name).toBe('MÃƒÆ’Ã‚Â¼ller');
    expect(res.rows[0].first_name).toBe('JosÃƒÆ’Ã‚Â©');
  });
...
describe('New table mappings', () => {
  ...
  it('migrates carcase data correctly', async () => {
    ...
    await pgPool.query("INSERT INTO system.lookups (category, code, label) VALUES ('breed', 1, 'Angus')");
    await pgPool.query(`
      INSERT INTO cattle.cows (ear_tag, legacy_beast_id, died, sex) VALUES ('C001', 400, false, 'steer')
    `);
  ...
  it('migrates autopsy records with findings JSONB', async () => {
    await pgPool.query("INSERT INTO system.lookups (category, code, label) VALUES ('breed', 1, 'Angus') ON CONFLICT DO NOTHING");
    await pgPool.query(`
      INSERT INTO cattle.cows (ear_tag, legacy_beast_id, died, sex) VALUES ('AP01', 500, true, 'steer')
    `);
...
describe('Large-dataset pagination', () => {
  ...
  it('processes 2000 breeds across multiple pages with batch size 50', async () => {
    ...
    const first = await pgPool.query("SELECT label FROM system.lookups WHERE category = 'breed' AND code = '1'");
    expect(first.rows[0].label).toBe('Breed_1');
    const last = await pgPool.query("SELECT label FROM system.lookups WHERE category = 'breed' AND code = '2000'");
    expect(last.rows[0].label).toBe('Breed_2000');
  });

  it('handles 1000 cattle ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ event chain across pages', async () => {
  ...
  it('pagination handles exact batch-size boundary correctly', async () => {
    // 200 rows with batch size 100 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â exactly 2 full pages, no partial page
    const breeds = [];
    for (let i = 1; i <= 200; i++) {
      breeds.push({ Breed_Code: i, Breed_Name: `Breed_${i}` });
    }
...
// DRY-RUN LOOKUPS Ã¢â‚¬â€ cow-dependent tables must not be skipped
// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
...
describe('Dry-run source-based lookups', () => {
  ...
  describe('buildCowIdMapFromSource', () => {
    it('builds a BeastID Ã¢â€ â€™ synthetic ID map from source', async () => {
      const mock = createMockMssql({
        'Cattle': [
          { BeastID: 100 },
          { BeastID: 200 },
  ...
  describe('buildSbRecNoMapFromSource', () => {
    it('builds an SB_Rec_No Ã¢â€ â€™ synthetic ID map from source', async () => {
      const mock = createMockMssql({
        'Sick_Beast_Records': [
          { SB_Rec_No: 10 },
          { SB_Rec_No: 20 },
  ...
  it('dry-run correctly identifies orphaned rows from source lookup', async () => {
    const mock = createMockMssql({
      ...
      'Sick_Beast_Records': [],
      'Weighing_Events': [
        // BeastID 1 exists Ã¢â‚¬â€ should be written
        { BeastID: 1, Weighing_Type: 1, Weigh_date: '2024-01-01', Weight: 300, P8_Fat: 5, Weigh_Note: null, ID: 1 },
        // BeastID 999 does NOT exist Ã¢â‚¬â€ should be skipped as orphan
