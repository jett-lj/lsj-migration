...
const mappings = [
  // ---- Order 10: Lookup tables (no dependencies) ----
  {
    ...
    columns: [
      ...
      { source: 'Breed_Name', target: 'label', transform: trimOrNull },
    ],
    staticColumns: { category: 'breed' },
    validate: (row) => row.label !== null && !JUNK_BREEDS.has(row.label),
  },
...

  {
    ...
    columns: [
      ...
      { source: 'Bank_AC',       target: 'bank_acct',             transform: trimOrNull },
...

  {
    ...
    columns: [
      ...
      { source: 'Rev_Exp',     target: 'cost_type',              transform: trimOrNull },
  ...
  // ---- Order 20: Purchase lots (depends on contacts) ----
  {
    ...
    columns: [
      ...
      { source: 'Number_Head',         target: 'numb_head',               transform: toNum },
...

  {
    ...
    query: `SELECT BeastID, Ear_Tag_No, Drug_ID, Batch_No, Date_Given,
                   ...
                   User_Initials, Where_given, Applied_to_Stockonhand,
...

  {
    ...
    columns: [
      ...
      { source: 'Extended_RevExp', target: 'total',            transform: toNum },
      { source: 'Ear_Tag',       target: 'ear_tag',            transform: trimOrNull },
...

  {
    ...
    columns: [
      ...
      { source: 'PH_level',          target: 'ph',                     transform: toNum },
      ...
      { source: 'Mscle_Colour',      target: 'meat_colour',            transform: toNum },
      ...
      { source: 'MSA_Index',         target: 'carc_msa_index',         transform: toNum },
...

  {
    ...
    columns: [
      ...
      { source: 'Form_Date',         target: 'date_signed',       transform: toDate },
...

  {
    ...
    columns: [
      { source: 'Cull_Reason_ID', target: 'code',            transform: trimOrNull },
...

  {
    ...
    columns: [
      ...
      { source: 'Sale_Type', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      ...
      { source: 'BodySystem', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      ...
      { source: 'Category_Description', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      ...
      { source: 'GrowerGroup_Name', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      ...
      { source: 'Location_Type', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      ...
      { source: 'Region_name', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      ...
      { source: 'Sire_Line', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    query: `SELECT Instrument_name, Test_date, Testing_method, Tester_name, Test_Notes, Data_applied_to_instruments, ID
            ...
            ORDER BY ID`,
    columns: [
      { source: 'Test_date',    target: 'calibration_date', transform: toDate },
...

  {
    ...
    columns: [
      ...
      { source: 'WeightGain_$perKg', target: 'weightgain_doll_per_kg', transform: toNum },
      ...
      { source: 'Notes', target: 'notes', transform: trimOrNull },
      { source: 'Agistor_TailTag', target: 'agistor_tailtag', transform: trimOrNull },
...

  {
    ...
    query: `SELECT BeastID, Ear_Tag, Movement_Date, From_Location, To_Location, ID
...

  {
    ...
    query: `SELECT BeastID, MoveDate
            ...
            ORDER BY BeastID`,
    columns: [
      { source: 'BeastID', target: 'cow_id', transform: toNum },
...

  {
    ...
    columns: [
      ...
      { source: 'Date_Calculated', target: 'calc_date', transform: toDate },
    ],
  },

  {
    ...
    // 10,972 rows — daily per-beast feed application log migrated to feed.cattle_feed_updates.
    // Columns feed_value and kgs_fed_calc (old names) are superseded by direct column names;
    // pen_feeds_data_id (FK to feed.penfeedsdata) has no MSSQL equivalent — left NULL.
...

  {
    ...
    columns: [
      { source: 'BeastID', target: 'cow_id', transform: toNum },
      { source: 'Ear_Tag', target: 'ear_tag', transform: trimOrNull },
      { source: 'Photo', target: 'photo', transform: toBytea },
...

  {
    ...
    columns: [
      ...
      { source: 'Mod_ule', target: 'module', transform: trimOrNull },
      { source: 'Proceedure_Name', target: 'procedure_name', transform: trimOrNull },
...

  {
    ...
    query: `SELECT FeedDate, Pen_Number, Ration_name, KilosFed, FeedValue, Applied_to_Cattle, ID, Dry_Matter, Last_Modified_timestamp
            ...
            ORDER BY ID`,
    columns: [
      { source: 'FeedDate', target: 'feeddate', transform: toDate },
      { source: 'Pen_Number', target: 'pen_number', transform: trimOrNull },
      { source: 'Ration_name', target: 'ration_name', transform: trimOrNull },
...

  {
    ...
    columns: [
      { source: 'Lot_Number', target: 'lot_number', transform: trimOrNull },
      { source: 'Numb_Head', target: 'head_count', transform: toNum },
      { source: 'Price_Cnts_per_Kg', target: 'price_cents_per_kg', transform: toNum },
      { source: 'Weight', target: 'weight', transform: toNum },
      { source: 'TailTag', target: 'tail_tag', transform: trimOrNull },
      { source: 'Vndr_Decl_No', target: 'vendor_decl_no', transform: trimOrNull },
      { source: 'Agistment_PIC', target: 'agistment_pic', transform: trimOrNull },
      { source: 'Last_Modified_timestamp', target: 'legacy_modified_at', transform: toDate },
    ],
  },
...

  {
    ...
    columns: [
      ...
      { source: 'Accum_Month_HeadDays', target: 'accum_month_headdays', transform: toNum },
    ],
  },
...

  {
    ...
    query: `SELECT MnthYYYYmmm, Head, ID
            ...
            ORDER BY ID`,
    columns: [
      { source: 'MnthYYYYmmm', target: 'yr_mnth',    transform: trimOrNull },
      { source: 'Head',         target: 'head_count', transform: toNum },
    ],
  },
...

  {
    ...
    query: 'SELECT Ration_Type_ID, Ration_Type FROM dbo.Ration_Types ORDER BY Ration_Type_ID',
    columns: [
      { source: 'Ration_Type_ID', target: 'ration_type_id' },
      { source: 'Ration_Type',    target: 'ration_type_desc', transform: trimOrNull },
    ],
  },
...

  {
    ...
    columns: [
      ...
      { source: 'Trans_Type_Long',  target: 'trans_desc',  transform: trimOrNull },
...

  {
    ...
    columns: [
      { source: 'DOF', target: 'mmec_code', transform: trimOrNull },
      { source: 'Target_Multiplier', target: 'mmec_desc', transform: trimOrNull },
    ],
  },

  {
    ...
    columns: [
      ...
      { source: 'Dockage_Reason', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      ...
      { source: 'Manure_Type', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    columns: [
      { source: 'Reason_ID',          target: 'code' },
      { source: 'Reason_Description', target: 'label', transform: trimOrNull },
    ],
...

  {
    ...
    query: `SELECT RationCode, MinNEM_Power_Raised, MinNEm_Constant, Consumpt_Avg_Constant,
                   Consumpt_Max_Constant, BumpIfSlick_Constant, ID
            FROM dbo.Ration_Calc_Constants ORDER BY ID`,
    columns: [
      { source: 'RationCode',            target: 'constant', transform: trimOrNull },
      { source: 'MinNEm_Constant',       target: 'value',    transform: toNum },
    ],
  },
...

  {
    ...
    query: `SELECT Truck_Number, Truck_Name, Max_Kgs_Load_Value
            FROM dbo.Truck_names ORDER BY Truck_Number`,
    columns: [
      { source: 'Truck_Name',         target: 'truck_name', transform: trimOrNull },
      { source: 'Max_Kgs_Load_Value', target: 'capacity',   transform: toNum },
    ],
  },
...

  {
    ...
    query: 'SELECT Pen_Number_ID, LaneOrder FROM dbo.PenLaneOrder ORDER BY Pen_Number_ID',
    columns: [
      { source: 'Pen_Number_ID', target: 'pen_number_id' },
      { source: 'LaneOrder',     target: 'lane_order',    transform: toNum },
    ],
  },

  {
    ...
    query: 'SELECT Pen_Number_ID, PrintOrder FROM dbo.Pen_Print_Order ORDER BY Pen_Number_ID',
    columns: [
      { source: 'Pen_Number_ID', target: 'pen_number_id' },
      { source: 'PrintOrder',    target: 'print_order',   transform: toNum },
    ],
  },

  {
    ...
    columns: [
      { source: 'UserName', target: 'user_name', transform: trimOrNull },
    ],
  },

  {
    ...
    query: 'SELECT COMport, BaudRate, ID FROM dbo.WbridgeCOMport ORDER BY ID',
    columns: [
      { source: 'COMport',  target: 'port_name', transform: trimOrNull },
      { source: 'BaudRate', target: 'baud_rate', transform: toNum },
      { source: 'ID',        target: 'id' },
    ],
  },
...

  {
    ...
    columns: [
      ...
      { source: 'Pay_rate_bonus_per_carcase_Kg', target: 'bonus_per_kg',   transform: toNum },
    ],
  },
...

  {
    ...
    query: `SELECT Ration_Code, Commodity_Code, Pcnt_of_Ration, Rec_Id
...

  {
    ...
    query: 'SELECT Commodity_Code, Stock_value, Stock_Tons_Weight FROM dbo.Period_Stocks_Closing_Balance ORDER BY Commodity_Code',
    columns: [
      { source: 'Commodity_Code',    target: 'commodity_code' },
      { source: 'Stock_value',       target: 'closing_value',  transform: toNum },
      { source: 'Stock_Tons_Weight', target: 'closing_qty',    transform: toNum },
    ],
  },

  {
    ...
    query: `SELECT Ration_Type FROM dbo.Pen_Feeding_Order_Params ORDER BY Ration_Type`,
    columns: [
...

  {
    ...
    query: `SELECT Titration_Regime_name, Date_defined, Ration_Code_Feed1, Start_day_Number, End_day_Number, ID
...

  {
    ...
    query: `SELECT Pen_name, Date_Pen_Cleaned, Comments
            FROM dbo.Pen_and_Bunk_Cleaning_Master ORDER BY Pen_name`,
    columns: [
      { source: 'Pen_name',        target: 'pen_name',   transform: trimOrNull },
      { source: 'Date_Pen_Cleaned', target: 'event_date', transform: toDate },
      { source: 'Comments',        target: 'notes',      transform: trimOrNull },
    ],
  },
...

  {
    ...
    sourceDatabase: 'CATTLE_feed',
    targetTable: 'commodity.commodities',
    query: `SELECT Commodity_Code, Commod_Name, Shrinkage_factor
            FROM dbo.Commodities ORDER BY Commodity_Code`,
    columns: [
      { source: 'Commodity_Code',   target: 'commodity_code' },
      { source: 'Commod_Name',      target: 'commodity_name', transform: trimOrNull },
...

  {
    ...
    query: `SELECT Supplier_ID, MRB_Avg_YR1, MRB_Avg_YR2, MRB_Avg_YR3, MRB_Avg_YR4, Supplier, ID
