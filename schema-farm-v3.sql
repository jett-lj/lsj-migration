-- ═══════════════════════════════════════════════════════════════════════
-- LSJ-HUB V3 Farm Database Schema (PostgreSQL)
...
-- sex CHECK is inline on cattle.cows (female/male) — no standalone needed
...
ALTER TABLE cattle.gps_locations ADD CONSTRAINT fk_gps_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE CASCADE;
ALTER TABLE cattle.cows ADD CONSTRAINT fk_cows_pen
    FOREIGN KEY (pen_id) REFERENCES pen.pens(id) ON DELETE SET NULL;
ALTER TABLE cattle.cows ADD CONSTRAINT fk_cows_purchase_lot
    FOREIGN KEY (purchase_lot_id) REFERENCES purchasing.purchase_lots(id) ON DELETE SET NULL;
-- REMOVED: fk_cows_market_category — market_category is TEXT (stores name, not id)
-- REMOVED: fk_cows_cull_reason — cull_reason is TEXT (stores reason text, not id)
ALTER TABLE cattle.cows ADD CONSTRAINT fk_cows_program_id
    FOREIGN KEY (program_id) REFERENCES cattle.cattle_program_types(id) ON DELETE SET NULL;
ALTER TABLE cattle.cows ADD CONSTRAINT fk_cows_vendor
    FOREIGN KEY (vendor_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE cattle.cows ADD CONSTRAINT fk_cows_agent
    FOREIGN KEY (agent_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE cattle.cows ADD CONSTRAINT fk_cows_custom_feed_owner
    FOREIGN KEY (custom_feed_owner_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;

-- cattle sub-tables → contacts, feed
ALTER TABLE cattle.agistment_transfer_register ADD CONSTRAINT fk_agistment_agistor
    FOREIGN KEY (agistor_code) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE cattle.new_cattle_records_log ADD CONSTRAINT fk_new_cattle_log_user
    FOREIGN KEY (user_number) REFERENCES feed.feedlot_staff(user_id) ON DELETE SET NULL;

-- health → cattle, contacts, feed
ALTER TABLE health.sick_beast_records ADD CONSTRAINT fk_sick_beast_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE health.sick_beast_records ADD CONSTRAINT fk_sick_beast_cattle
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE health.sick_beast_records ADD CONSTRAINT fk_sick_beast_disease
    FOREIGN KEY (disease_id) REFERENCES health.diseases(id) ON DELETE SET NULL;
ALTER TABLE health.sick_beast_records ADD CONSTRAINT fk_sick_beast_diagnoser
    FOREIGN KEY (diagnoser_empl_id) REFERENCES feed.feedlot_staff(user_id) ON DELETE SET NULL;
ALTER TABLE health.sick_beast_records ADD CONSTRAINT fk_sick_beast_custfeedowner
    FOREIGN KEY (customfeedownerid) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE health.drugs_given ADD CONSTRAINT fk_drugs_given_drug
    FOREIGN KEY (drug_id) REFERENCES health.drugs(id) ON DELETE SET NULL;
ALTER TABLE health.drugs_given ADD CONSTRAINT fk_drugs_given_sb
    FOREIGN KEY (sb_rec_no) REFERENCES health.sick_beast_records(sb_rec_no) ON DELETE SET NULL;
ALTER TABLE health.autopsy_records ADD CONSTRAINT fk_autopsy_sb
    FOREIGN KEY (sb_rec_no) REFERENCES health.sick_beast_records(sb_rec_no) ON DELETE RESTRICT;
ALTER TABLE health.autopsy_records ADD CONSTRAINT fk_autopsy_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE health.sick_beast_temperatures ADD CONSTRAINT fk_sbt_sb
    FOREIGN KEY (sb_rec_no) REFERENCES health.sick_beast_records(sb_rec_no) ON DELETE SET NULL;
ALTER TABLE health.sick_beast_temperatures ADD CONSTRAINT fk_sbt_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE health.drug_hgp_forms ADD CONSTRAINT fk_hgp_receival
    FOREIGN KEY (drug_receival_id) REFERENCES health.drugs_purchase_event(id) ON DELETE RESTRICT;
ALTER TABLE health.drugs_purchased ADD CONSTRAINT fk_drugs_purchased_receival
    FOREIGN KEY (receival_id) REFERENCES health.drugs_purchase_event(id) ON DELETE RESTRICT;
ALTER TABLE health.drugs_purchased ADD CONSTRAINT fk_drugs_purchased_drug
    FOREIGN KEY (drug_id) REFERENCES health.drugs(id) ON DELETE RESTRICT;
ALTER TABLE health.drug_inventory_line_items ADD CONSTRAINT fk_inv_line_drug
    FOREIGN KEY (drug_id) REFERENCES health.drugs(id) ON DELETE RESTRICT;

-- feed → pen, commodity, cattle, contacts
ALTER TABLE feed.bunk_readings ADD CONSTRAINT fk_bunk_pen
    FOREIGN KEY (pen_number_id) REFERENCES pen.pens_file(pen_number_id) ON DELETE SET NULL;
ALTER TABLE feed.bunk_readings ADD CONSTRAINT fk_bunk_ration
    FOREIGN KEY (ration_code) REFERENCES feed.ration_descriptions(ration_code) ON DELETE SET NULL;
ALTER TABLE feed.ration_regimes ADD CONSTRAINT fk_ration_regime_pen
    FOREIGN KEY (pen_id) REFERENCES pen.pens_file(pen_number_id) ON DELETE SET NULL;
ALTER TABLE feed.paddock_feeding ADD CONSTRAINT fk_paddock_feed_commodity
    FOREIGN KEY (commodity_id) REFERENCES commodity.commodities(commodity_code) ON DELETE RESTRICT;
ALTER TABLE feed.paddock_feeding ADD CONSTRAINT fk_paddock_feed_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE feed.cattle_feed_updates ADD CONSTRAINT fk_cattle_feed_updates_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE feed.penfeedsdata ADD CONSTRAINT fk_penfeedsdata_pen
    FOREIGN KEY (pen_number_id) REFERENCES pen.pens_file(pen_number_id) ON DELETE RESTRICT;
ALTER TABLE feed.penfeedsdata ADD CONSTRAINT fk_penfeedsdata_ration
    FOREIGN KEY (ration_code) REFERENCES feed.ration_descriptions(ration_code) ON DELETE SET NULL;
ALTER TABLE feed.vendor_declarations ADD CONSTRAINT fk_vendor_decl_owner
    FOREIGN KEY (owner_contact_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;

-- pen → cattle, feed
ALTER TABLE pen.penshistory ADD CONSTRAINT fk_penshistory_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE pen.penshistory ADD CONSTRAINT fk_penshistory_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE pen.penriders_log ADD CONSTRAINT fk_penriders_employee
    FOREIGN KEY (employee_id) REFERENCES feed.feedlot_staff(user_id) ON DELETE RESTRICT;

-- finance → cattle, contacts, purchasing, commodity
ALTER TABLE finance.costs ADD CONSTRAINT fk_costs_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.costs ADD CONSTRAINT fk_costs_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.costs ADD CONSTRAINT fk_costs_code
    FOREIGN KEY (revexp_code) REFERENCES finance.cost_codes(revexp_code) ON DELETE RESTRICT;
ALTER TABLE finance.costs_feed_detail ADD CONSTRAINT fk_costsfeed_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.costs_feed_detail ADD CONSTRAINT fk_costsfeed_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.custfeed_invoices_list ADD CONSTRAINT fk_custfeed_inv_lot
    FOREIGN KEY (purch_lot_no) REFERENCES purchasing.purchase_lots(lot_number) ON DELETE SET NULL;
ALTER TABLE finance.price_adjustment_by_weight_range ADD CONSTRAINT fk_priceadj_lot
    FOREIGN KEY (lot_number) REFERENCES purchasing.purchase_lots(lot_number) ON DELETE RESTRICT;
ALTER TABLE finance.tandr_buying_details ADD CONSTRAINT fk_tandr_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.tandr_buying_details ADD CONSTRAINT fk_tandr_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.tandr_buying_details ADD CONSTRAINT fk_tandr_agent
    FOREIGN KEY (agent_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE finance.tandr_buying_details ADD CONSTRAINT fk_tandr_buyer
    FOREIGN KEY (buyer_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE finance.tandr_buying_details ADD CONSTRAINT fk_tandr_supplier
    FOREIGN KEY (supplier_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE finance.beast_accumed_feed_by_commodity ADD CONSTRAINT fk_accumfeed_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.beast_accumed_feed_by_commodity ADD CONSTRAINT fk_accumfeed_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE finance.beast_accumed_feed_by_commodity ADD CONSTRAINT fk_accumfeed_commod
    FOREIGN KEY (commodity_code) REFERENCES commodity.commodities(commodity_code) ON DELETE RESTRICT;

-- carcase → cattle, contacts
ALTER TABLE carcase.carcase_data ADD CONSTRAINT fk_carcase_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE carcase.carcase_data ADD CONSTRAINT fk_carcase_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE carcase.carcase_data ADD CONSTRAINT fk_carcase_sold_to
    FOREIGN KEY (sold_to_contact_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE carcase.carcase_data ADD CONSTRAINT fk_carcase_abattoir
    FOREIGN KEY (abattoir_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;

-- purchasing → contacts, cattle
ALTER TABLE purchasing.purchase_lots ADD CONSTRAINT fk_purch_lots_owner
    FOREIGN KEY (cattle_owner_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE purchasing.purchase_lots ADD CONSTRAINT fk_purch_lots_vendor
    FOREIGN KEY (vendor_id) REFERENCES contacts.contacts(id) ON DELETE SET NULL;
ALTER TABLE purchasing.purchase_lots ADD CONSTRAINT fk_purch_lots_agent
    FOREIGN KEY (agent_code) REFERENCES contacts.contacts(id) ON DELETE SET NULL;

-- commodity → contacts
ALTER TABLE commodity.commodcontracts ADD CONSTRAINT fk_commodcontracts_supplier
    FOREIGN KEY (supplier_ac_no) REFERENCES contacts.contacts(id) ON DELETE RESTRICT;

-- breeding → cattle
ALTER TABLE breeding.beast_breeding ADD CONSTRAINT fk_beast_breeding_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE breeding.beast_breeding ADD CONSTRAINT fk_beast_breeding_cattle
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;

-- weighing → cattle
ALTER TABLE weighing.weighing_events ADD CONSTRAINT fk_weighing_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE weighing.weighing_events ADD CONSTRAINT fk_weighing_cattle
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;

-- transport → cattle, commodity, feed
ALTER TABLE transport.truck_loads ADD CONSTRAINT fk_truckloads_ration
    FOREIGN KEY (ration_code) REFERENCES feed.ration_descriptions(ration_code) ON DELETE RESTRICT;
ALTER TABLE transport.deliverydockets ADD CONSTRAINT fk_dockets_commodity
    FOREIGN KEY (commodity_code) REFERENCES commodity.commodities(commodity_code) ON DELETE SET NULL;
ALTER TABLE transport.location_changes ADD CONSTRAINT fk_locchanges_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE transport.location_changes ADD CONSTRAINT fk_locchanges_beast
    FOREIGN KEY (beast_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;

-- system → feed
ALTER TABLE system.user_log_ons ADD CONSTRAINT fk_userlogons_user
    FOREIGN KEY (user_number) REFERENCES feed.feedlot_staff(user_id) ON DELETE RESTRICT;

-- OG web-app FK constraints (pen, operations, feed tables)
ALTER TABLE pen.pens ADD CONSTRAINT fk_og_pens_ration
    FOREIGN KEY (ration_id) REFERENCES feed.rations(id) ON DELETE SET NULL;
ALTER TABLE pen.pen_movements ADD CONSTRAINT fk_pen_move_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE pen.pen_movements ADD CONSTRAINT fk_pen_move_pen
    FOREIGN KEY (pen_id) REFERENCES pen.pens(id) ON DELETE CASCADE;
ALTER TABLE operations.batch_pen_operations ADD CONSTRAINT fk_batch_pen_from
    FOREIGN KEY (from_pen_id) REFERENCES pen.pens(id) ON DELETE SET NULL;
ALTER TABLE operations.batch_pen_operations ADD CONSTRAINT fk_batch_pen_to
    FOREIGN KEY (to_pen_id) REFERENCES pen.pens(id) ON DELETE SET NULL;
ALTER TABLE operations.nlis_transfers ADD CONSTRAINT fk_nlis_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE SET NULL;
-- NOTE: fk_costs_cow, fk_carcase_cow, fk_weighing_cow already defined above
ALTER TABLE finance.costs ADD CONSTRAINT fk_costs_cost_code
    FOREIGN KEY (cost_code_id) REFERENCES finance.cost_codes(id) ON DELETE SET NULL;
ALTER TABLE health.autopsy_records ADD CONSTRAINT fk_autopsy_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;

-- cow_id FKs for remaining OG tables (beast_id only → now cow_id too)
ALTER TABLE health.sick_beast_brd_symptoms ADD CONSTRAINT fk_brd_symptoms_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE carcase.carcase_datatype2 ADD CONSTRAINT fk_carcase_dt2_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE carcase.carcase_feedback_report_data ADD CONSTRAINT fk_carc_feedback_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE reporting.cattle_query_month_report ADD CONSTRAINT fk_cattle_qry_report_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
ALTER TABLE operations.transport_dispatch_items ADD CONSTRAINT fk_dispatch_item_cow
    FOREIGN KEY (cow_id) REFERENCES cattle.cows(id) ON DELETE RESTRICT;
...
-- ██  OG table names → V3 schema-qualified tables
-- ████████████████████████████████████████████████████████████████
...
-- ████████████████████████████████████████████████████████████████
-- ██  END OF V3 FARM SCHEMA
-- ██  ~195 tables across 17 schemas + legacy views
-- ██  5 partitioned tables × 9 yearly partitions each
-- ██  100+ indexes (FK, search, partial, composite)
-- ████████████████████████████████████████████████████████████████
