...
const TABLE_CATEGORIES = {
  ...
  'Cattle_Feed_Update': { strategy: 'raw', reason: 'No direct v3 table — feed application log' },
  ...
  'Drug_Stocktake_records': { strategy: 'raw', reason: 'Consolidated into health.drug_inventory in v3' },
  ...
  'RationNames': { strategy: 'mapped', target: 'feed.rationnames' },
  ...
  'Ration_Descriptions':               { strategy: 'mapped', target: 'feed.ration_descriptions' },
